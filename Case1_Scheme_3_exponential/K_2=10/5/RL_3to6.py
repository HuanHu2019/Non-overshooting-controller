...
class Fuckingfly:
    ...
    def step(self, action):
        ...
        shineng_now,xishu,xishu2,reward_pan,reward_pan_sec,reward_third,reward_forth = shinengjisuan(self.initial,    self.end ,   fuck_fu[-1])
...
def shinengjisuan(initial,end,feigao):
        ...
        cost_n =  (1 - np.clip(juli/fenmu,0,1) )**10
        ...
        if quanbu:
                ...
                #return cost_n*1,1,1,reward_pan*40,reward_pan_2*1600,reward_pan_3*40*40*40  #reward_pan*20
                    return cost_n*1,1,1,reward_pan*(jieshoubu+2),0,0,0
